...
def main():
    ...
    # Since 10-K is annual, adjust the limit accordingly
    # For example, for 4 quarters, you might expect 1 10-K and 3 10-Q filings
    # To ensure enough filings, set the limit to number_of_quarters + 1
    limit = number_of_quarters + 1
    
    fetched_data = extractor.get_latest_fields(identifier, form_types, limit)
